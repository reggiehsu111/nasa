(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('universal-user-agent'), require('tslib'), require('crypto'), require('debug'), require('priorityqueuejs'), require('semaphore'), require('fast-json-stable-stringify'), require('uuid/v4'), require('node-abort-controller'), require('node-fetch')) :
    typeof define === 'function' && define.amd ? define(['exports', 'universal-user-agent', 'tslib', 'crypto', 'debug', 'priorityqueuejs', 'semaphore', 'fast-json-stable-stringify', 'uuid/v4', 'node-abort-controller', 'node-fetch'], factory) :
    (global = global || self, factory((global.Microsoft = global.Microsoft || {}, global.Microsoft.Azure = global.Microsoft.Azure || {}, global.Microsoft.Azure.Cosmos = {}), global.universalUserAgent, global.tslib_1, global.crypto, global.debugLib, global.PriorityQueue, global.semaphore, global.stableStringify, global.uuid, global.AbortController, global.fetch));
}(this, function (exports, universalUserAgent, tslib_1, crypto, debugLib, PriorityQueue, semaphore, stableStringify, uuid, AbortController, fetch) { 'use strict';
    ...
    class LocationCache {
        ...
        shouldRefreshEndpoints() {
            ...
            if (this.options.connectionPolicy.enableEndpointDiscovery) {
                ...
                const shouldRefresh = this.options.connectionPolicy.useMultipleWriteLocations &&
                    !this.enableMultipleWritableLocations;
